...
class SITE:
    ...
    def insert(self, cursor):
        cursor.execute("INSERT INTO SITE (site_name) VALUES (%s)", (self.site_id,))
...
class SITE_WORKER:
    ...
    def insert(self, cursor):
        cursor.execute("INSERT INTO SITE_WORKER (employee_id, site_name) VALUES (%s, %s)", (self.employee_id, self.site_id))
...
class SW_CONTRACT:
    def __init__(self, SITE_WORKER: SITE_WORKER):
        ...
        self.employee_id = SITE_WORKER.employee_id
    def insert(self, cursor):
        cursor.execute("INSERT INTO SW_CONTRACT (contract_id, site_name, employee_id) VALUES (%s, %s, %s)", (self.contract_id, self.site_id, self.employee_id))

class SW_TEMPORARY_CONTRACT:
    def __init__(self, SW_CONTRACT: SW_CONTRACT):
        self.temp_contract_id = uuid.uuid4()
    ...
    def insert(self, cursor):
        cursor.execute("""
                       INSERT INTO SW_TEMPORARY_CONTRACT 
                       (temp_contract_id, 
                        contract_id, 
                        site_name, 
                        employee_id, 
...
class SW_PERMANENT_CONTRACT:
    def __init__(self, SW_CONTRACT: SW_CONTRACT):
        self.perm_contract_id = uuid.uuid4()
        self.contract_id = SW_CONTRACT.contract_id
        self.site_name = SW_CONTRACT.site_name
        self.employee_id = SW_CONTRACT.employee_id
        self.start_date = fake.date_between(start_date='-5y', end_date='today').strftime('%Y-%m-%d %H:%M:%S')
...
class SITE_MANAGER:
    def __init__(self, SITE_WORKER: SITE_WORKER, SITE: SITE):
        self.site_manager_id = uuid.uuid4()
        self.employee_id = SITE_WORKER.employee_id
        self.site_name = SITE.site_name
    def insert(self, cursor):
...
class PLANTATION:
    ...
    def insert(self, cursor):
        cursor.execute("INSERT INTO PLANTATION (plantation_id) VALUES (%s)", (self.plantation_name,))
...
class PW_TEMPORARY_CONTRACT:
    def __init__(self, PW_CONTRACT: PW_CONTRACT):
        ...
        self.end_date = fake.date_between(start_date='today', end_date='today').strftime('%Y-%m-%d %H:%M:%S')
    def insert(self, cursor):
        cursor.execute("INSERT INTO PW_TEMPORARY_CONTRACT (temp_contract_id, contract_id, plantation_name, employee_id, start_date, end_date) VALUES (%s, %s, %s, %s, %s, %s)", (self.temp_contract_id, self.contract_id, self.plantation_id, self.employee_id, self.start_date, self.end_date))
...
class PLANTATION_MANAGER:
    def __init__(self, PLANTATION_WORKER: PLANTATION_WORKER, PLANTATION: PLANTATION):
        self.plantation_manager_id = uuid.uuid4()
        self.employee_id = PLANTATION_WORKER.employee_id
        self.plantation_name = PLANTATION.plantation_name
    def insert(self, cursor):
...
# ==============================================|  PRODUCTION ROUTE  |=====================================================
class INVENTORY:
    def __init__(self, SITE: SITE, PLANTATION: PLANTATION, harvest_date):
        self.harvest_date = harvest_date
        self.site_name = SITE.site_name
        self.plantation_name = PLANTATION.plantation_name
    def insert(self, cursor):
        cursor.execute("INSERT INTO INVENTORY (harvest_date, site_id, plantation_id) VALUES (%s, %s, %s)", (self.harvest_date, self.site_name, self.plantation_name))
        
class BATCH:
    def __init__(self, INVENTORY: INVENTORY, synthesis_unit):
        self.synthesis_unit = synthesis_unit
        self.harvest_date = INVENTORY.harvest_date
        self.plantation_name = INVENTORY.plantation_name
        self.site_name = INVENTORY.site_name
    def insert(self, cursor):
        cursor.execute("INSERT INTO BATCH (synthesis_unit, harvest_date, plantation_name, site_name) VALUES (%s, %s, %s, %s)", (self.synthesis_unit, self.harvest_date, self.plantation_name, self.site_name))

class IPC:
    def __init__(self, BATCH: BATCH):
        self.ipc_id = uuid.uuid4()
        self.synthesis_unit = BATCH.synthesis_unit
        self.harvest_date = BATCH.harvest_date
        self.plantation_name = BATCH.plantation_name
        self.site_name = BATCH.site_name
    def insert(self, cursor):
        cursor.execute("INSERT INTO IPC (ipc_id, synthesis_unit, harvest_date, plantation_name, site_name) VALUES (%s, %s, %s, %s, %s)", (self.ipc_id, self.synthesis_unit, self.harvest_date, self.plantation_name, self.site_name))
...
class STOCK:
    def __init__(self, BATCH: BATCH):
        ...
        self.site_name = BATCH.site_name
    def insert(self, cursor):
        cursor.execute("INSERT INTO STOCK (stock_id, synthesis_unit, harvest_date, plantation_name, site_name) VALUES (%s, %s, %s, %s, %s)", (self.stock_id, self.synthesis_unit, self.harvest_date, self.plantation_name, self.site_name))
...
class SALE:
    def __init__(self, SALES_ASSOCIATE: SALES_ASSOCIATE, 
        ...
        self.synthesis_unit = STOCK.synthesis_unit
        self.harvest_date = STOCK.harvest_date
        self.plantation_name = STOCK.plantation_name
        self.site_name = STOCK.site_name
    def insert(self, cursor):
        cursor.execute("INSERT INTO SALE (sale_id, sales_associate_id, client_id, stock_id, synthesis_unit, harvest_date, plantation_name, site_name) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)", (self.sale_id, self.sales_associate_id, self.client_id, self.stock_id, self.synthesis_unit, self.harvest_date, self.plantation_name, self.site_name))
